...
-   **Poisson Distribution**
    ...
    **You can sample from Poisson distribution, too**
    ...
    The gamma distribution is flexible and applicable to various contexts, including modeling time to events, environmental data, and more. It is characterized by the shape ($\alpha$) and scale ($\beta$) parameters and it is defined for non-negative random variables.
...
We can see that the average air temperatures in a month approximately follow a normal distribution. However a better visaul tool for checking normality is the quantile-quantile plot (QQ-plot).
