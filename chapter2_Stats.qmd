...
You can generate samples from different probability mpdel in R using the `r_distribution` operation. You can specify the parameters and the number of samples to be generated.
